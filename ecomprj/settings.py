...
SECRET_KEY = 'django-insecure-!xnq@epw$21&x3_kwmw39&e0_sr#$f!!3(vz(cs@8rt(%i=70g'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'templates/core/Delicious/assets')
]
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'templates/core/Delicious/')
